(function () {
    ...
    function init(sourcePanel) {
        ...
        style.textContent = `
            ...
            .sp-move-to-folder-button:hover,
            ...
            .sp-more-button:active,
            .sp-move-to-folder-button:active,
            ...
            .source-item.gated,
            .group-container.gated > .group-children {
                opacity: 0.5;
                filter: grayscale(50%);
            }
            .failed-source {
            ...
            .failed-source .title-container,
            .failed-source .icon-container {
